...
const MONGO_URI = process.env.MONGODB_URI || process.env.MONGO_URI || "mongodb://127.0.0.1:27017/king-dine";
        ...
        const restaurantData = [
            {
                name: "RSVP Lagos",
                slug: "oja-lagos",
                description: "A contemporary celebration of Nigerian cuisine in the heart of Lekki Phase 1. Oja Lagos blends bold West African flavors with elegant presentation and warm hospitality, offering a vibrant dining experience centered on fresh seafood, classic suya, and signature jollof rice.",
            ...
            },
            {
                name: "Tar Tar",
                slug: "the-burgundry",
                description: "An elegant modern French dining destination from Chef Stone. The Burgundry blends refined Burgundy-inspired cuisine with luxurious presentation and a warm, intimate atmosphere, highlighting premium local ingredients and sophisticated wine pairings.",
            ...
            },
            {
                name: "CILANTRO ABUJA",
                slug: "cilantro-abuja",
                description: "A luxurious fusion of international fine dining and Nigerian hospitality. CILANTRO ABUJA showcases Chef Stone's signature tasting menu in a sleek, modern space located in the heart of Maitama, Abuja.",
            ...
            },
            {
                ...
                description: "Above Lifestyle brings a luxury lounge and dining experience to Lekki, combining modern continental plates with relaxed coastal vibes. Expect elevated small plates, signature cocktails, and panoramic views.",
            ...
            },
            {
                ...
                description: "Kapadoccia aka The Cave offers an immersive dining experience inspired by Anatolian cave restaurants — now reimagined for FCT Abuja with rustic stone interiors, charcoal-fired specialties, and intimate private dining caves.",
            ...
            },
            {
                name: "SEE",
                slug: "see",
                description: "SEE brings contemporary Japanese dining to the city with refined omakase courses, seasonal ingredients, and an elegant, minimal dining room.",
                cuisine: "Japanese",
                priceRange: "$$$$",
                rating: 4.9,
                reviewCount: 124,
            ...
            },
            {
                name: "Walis Suites",
                slug: "walis-suites",
                description: "Walis Suites offers refined hotel dining on Monrovia Street, Abuja — combining elegant continental dishes with attentive service in a sophisticated suite-style setting.",
                cuisine: "Contemporary",
                priceRange: "$$$",
                rating: 4.9,
                reviewCount: 88,
